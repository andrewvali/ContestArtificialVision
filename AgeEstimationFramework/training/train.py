...
if args.dataset == 'vggface2_gender':
    sys.path.append("/content/Age_Estimation/")
    from vgg2_dataset_ageEstimation import Vgg2DatasetGender as Dataset, NUM_CLASSES
else:
...
if args.mode.startswith('train'):
    ...
    dataset_training = Dataset('/content/Age_Estimation/train', target_shape=INPUT_SHAPE, augment=False, preprocessing=args.preprocessing, custom_augmentation=custom_augmentation)
    dataset_validation = Dataset('/content/Age_Estimation/val', target_shape=INPUT_SHAPE, augment=False, preprocessing=args.preprocessing)
