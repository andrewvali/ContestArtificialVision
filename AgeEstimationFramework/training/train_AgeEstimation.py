...
if args.center_loss:
    ...
    loss = [loss] if NUM_CLASSES > 1 else keras.losses.mean_squared_error
    #loss = [keras.losses.categorical_crossentropy] if NUM_CLASSES > 1 else keras.losses.mean_squared_error
#accuracy_metrics = [keras.metrics.mean_absolute_error] if NUM_CLASSES > 1 else [keras.metrics.mean_squared_error]
accuracy_metrics = [keras.metrics.categorical_crossentropy,mae] if NUM_CLASSES > 1 else [keras.metrics.mean_squared_error]
